...
Dim colSoftware: Set colSoftware = objWMIService.ExecQuery ("Select * from Win32_Product Where Name like 'Java%' and not Name like 'Java Auto Updater'")


For Each objSoftware in colSoftware
objShell.popup "Uninstalling Name: " & objSoftware.Name & " v. " & objSoftware.Version,20,dlgName
